...
Release manifests pin every OCI image by digest. Schema v2 releases include the control plane, web, and worker images. Installation-owned Fly configuration consumes those exact references. Tags are descriptive and are never deployment identity.
